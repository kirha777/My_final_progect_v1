...
class DCT {
    ...
    public int N        = 8; //DCT Block Size - default 8
    public int QUALITY = 80; //Image Quality (0-100) - default 80 (good image / good compression)

    public int quantum[][] = new int[2][];
    public double Divisors[][] = new double[2][];

    public int quantum_luminance[]     = new int[N*N]; //Quantitization Matrix for luminace
    public double DivisorsLuminance[] = new double[N*N];

    public int quantum_chrominance[]     = new int[N*N]; //Quantitization Matrix for chrominance
